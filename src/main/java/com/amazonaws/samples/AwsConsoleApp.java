...
public class AwsConsoleApp {
     ...
     *      (/Users/davidbarrineau/.aws/credentials) where the sample code will load the
     *      credentials from.
    ...
    private static void init() throws Exception {
        ...
        /*
         * The ProfileCredentialsProvider will return your [David]
         * credential profile by reading from the credentials file located at
         * (/Users/davidbarrineau/.aws/credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/Users/davidbarrineau/.aws/credentials), and is in valid format.",
                    e);
        }
        ...
        // CDB Added.
        iam = AmazonIdentityManagementClientBuilder.standard().build();
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // CDB Added.
        try {
        	System.out.println(iam.getAccountPasswordPolicy());
        }
